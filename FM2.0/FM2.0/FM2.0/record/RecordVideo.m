...
#endif
    NSMutableDictionary *t_dic = [[NSMutableDictionary alloc]initWithDictionary:[camera.videoOutput recommendedVideoSettingsForAssetWriterWithOutputFileType:AVFileTypeQuickTimeMovie]];
