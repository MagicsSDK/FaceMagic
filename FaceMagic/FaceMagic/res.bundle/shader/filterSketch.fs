...
void main()
{
//    vec2 Setp = 1.0 / samplerSteps;
//    vec2 realPosition = v_texcoord0 / samplerSteps;
//    centralPos.y = 1.0/samplerSteps.y - centralPos.y;
...
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(0,2.0*samplerSteps.y));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(2.0*samplerSteps.x,0));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(0,-2.0*samplerSteps.y));
...
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(2.0*samplerSteps.x,2.0*samplerSteps.y));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(-2.0*samplerSteps.x,-2.0*samplerSteps.y));
...
//    
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(0,3.0*samplerSteps.y));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(3.0*samplerSteps.x,0));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(0,-3.0*samplerSteps.y));
...
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(3.0*samplerSteps.x,3.0*samplerSteps.y));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(-3.0*samplerSteps.x,-3.0*samplerSteps.y));
...
//    
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(0,4.0*samplerSteps.y));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(4.0*samplerSteps.x,0));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(0,-4.0*samplerSteps.y));
...
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(4.0*samplerSteps.x,4.0*samplerSteps.y));
//    grayTemp = colorTemp.r*0.299 + colorTemp.g*0.587 + colorTemp.b*0.114;
//    Edge = Edge + gray - grayTemp;
//    
//    colorTemp = texture2D(aTexture0,t_texcoord+vec2(-4.0*samplerSteps.x,-4.0*samplerSteps.y));
